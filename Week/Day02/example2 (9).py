...
first_data['일자']=int(data[0]['results'][0]['properties']['일차']['number'])
value=int(data[0]['results'][0]['properties']['단계']['select']['name'])
first_data['단계']=f'{value}단계'
first_data['과목']=data[0]['results'][0]['properties']['과목']['multi_select'][-1]['name']
print(first_data)
